...
* Search our existing [Issues](https://github.com/uber/h3/issues) as this may also help you.

If you’re still facing issues and need further help, then we recommend the following process:
* Open an [issue](https://github.com/uber/h3/issues/new/choose).
...
* Perform a [search](https://github.com/uber/h3/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
Enhancements and new features suggestions are tracked as [issues](https://github.com/uber/h3/issues).
...
* To see if other users have experienced (and potentially already solved) the same issue you are having, **check if there is not already a bug report** existing for your bug or error in the [bug list](https://github.com/uber/h3/issues?q=is%3Aissue%20state%3Aopen%20label%3Abug). If it has and the issue is still open, add a comment to the existing issue instead of opening a new one
...
* Open an [issue](https://github.com/uber/h3/issues/new/choose) selecting the bug report template.
...
* Check if there is an [issue](https://github.com/uber/h3/issues/new/choose) that highlights the same problem that you want to solve or that requests the same feature that you want to implement. If this is the case, then **remember to link the issue in your Pull Request**.
* You might also want to check if a similar [pull request](https://github.com/uber/h3/pulls) has already been created.
...
* Follow this [Pull Request template](https://github.com/uber/h3/blob/main/.github/pull_request_template.md).
